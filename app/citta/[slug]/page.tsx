      ...
      <section className="bg-white px-6 py-28 lg:px-12">
        <div className="luxury-grid mx-auto max-w-[1800px] gap-8">
          <div className="col-span-12 lg:col-span-4">
            <h2 className="fluid-section-title mobile-safe-copy font-display font-extrabold leading-none">Servizi disponibili in zona</h2>
          </div>
      ...
      <section className="gold-mesh px-6 py-32 lg:px-12">
        <div className="luxury-grid mx-auto max-w-[1800px]">
          <div className="col-span-12 lg:col-span-8">
            <h2 className="fluid-section-title mobile-safe-copy font-display font-extrabold leading-none tracking-[-0.04em]">Serve un intervento a {city.name}?</h2>
          </div>
